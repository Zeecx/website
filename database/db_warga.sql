...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 11, 2023 at 03:14 PM
...
CREATE TABLE `aset` (
  ...
  `id_aset_keluarga` int(11) NOT NULL,
  `jumlah_motor` int(11) NOT NULL,
  `jumlah_mobil` int(11) NOT NULL,
  `jumlah_kekayaan` decimal(10,0) NOT NULL
...
(2, '5325234324', 2, 'fsdfsdf', 'fdsfsdf', 'sfsfdsf', 'sdffsdff', 'sdfsdfdsfds', 'Indonesia', '1', '2', '1241', 1, '2023-07-11 07:43:31', '0000-00-00 00:00:00');
...
(1, 'codingwebgratis', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin di aplikasi pendataan warga', 'Admin', 'Senen', 'Salemba', 'Jakarta Pusat', 'DKI Jakarta', 'Indonesia', '001', '002', '2023-07-11 07:38:45', '2018-10-26 13:01:49'),
...
(2, '89329478', 'adia', 'aceh', '2009-06-09', 'L', 'tretertre', 'tertertretere', 'Senen', 'Salemba', 'Jakarta Pusat', 'DKI Jakarta', 'Indonesia', '001', '002', 'Katholik', 'SD', 'sihfs', 'Tidak Kawin', 'Kontrak', 1, '2023-07-11 07:42:44', '0000-00-00 00:00:00');
...
INSERT INTO `warga_has_kartu_keluarga` (`id_warga`, `id_keluarga`, `id_aset`) VALUES
(1, 2, 0),
(2, 2, 0);
...
ALTER TABLE `aset`
  ...
  ADD KEY `id_aset_keluarga` (`id_aset_keluarga`);
...
--
ALTER TABLE `aset`
  ADD CONSTRAINT `aset_ibfk_1` FOREIGN KEY (`id_aset_keluarga`) REFERENCES `kartu_keluarga` (`id_kepala_keluarga`);
